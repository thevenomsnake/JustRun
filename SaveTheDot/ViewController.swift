...
fileprivate extension ViewController {
  ...
  func getGameOverTitleAndMessage() -> (String, String) {
    ...
    case 10..<20: return ("Another go 😉", "No bad, you are getting there 😁")
    case 20..<40: return ("Play again 😉", "Very good ☺️")
    case 40..<60: return ("That's good 😃", "I believe you will do much better next time👍")
    default:
      return ("Off cause 😚", "Legend,  White Players, go douyu.TV")
    }
  }
